...
class FClass
{
    ...
    */
    virtual void meanValue(std::vector<pDescriptor> const& descriptors, TDescriptor& mean) = 0;
    ...
    * @return distance
    */
    static double distance(TDescriptor const& a, TDescriptor const& b);
    ...
    */
    static void fromString(TDescriptor& a, std::string const& s);
