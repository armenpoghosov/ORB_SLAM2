...
class FeatureVector : public std::map<NodeId, std::vector<uint32_t> >
{
public:
    ...
    ///
    void addFeature(NodeId id, uint32_t i_feature)
        { (*this)[id].push_back(i_feature); }
    ...
    */
    friend std::ostream& operator << (std::ostream &out, FeatureVector const& v);
};
